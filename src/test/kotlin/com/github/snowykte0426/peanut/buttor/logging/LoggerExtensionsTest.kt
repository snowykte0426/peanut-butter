...
class LoggerExtensionsTest : FunSpec({
    ...
    test("logger() should return logger with correct name") {
        ...
        logger.name shouldBe "logging.com.github.snowykte0426.peanut.buttor.TestClass"
    }
    ...
    test("lazyLogger should create logger lazily") {
        ...
        lazyLogger.name shouldBe "logging.com.github.snowykte0426.peanut.buttor.TestClass"
    }
    
    test("companionLogger should return logger for enclosing class") {
        val logger = TestClassWithCompanion.logger()
        
        logger.name shouldBe "logging.com.github.snowykte0426.peanut.buttor.TestClassWithCompanion"
    }
